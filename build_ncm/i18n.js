...
const MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "library.intro": "Select a building to replace the spatial preview, NCM payload, material counts and BOM. Each library entry owns deterministic geometry and defaults while continuing to use the shared material-style system.",
    "library.future": "SCROLL LIBRARY · DOORS PLACED SEPARATELY",
    "library.aria": "Available NCM buildings",
    "library.count": "{count} BUILDINGS",
    "library.selectAria": "Select {building}",
    "library.category.residential": "RESIDENTIAL / REFERENCE",
    "library.category.civic": "CIVIC / GOVERNANCE",
    "library.category.coastal": "COASTAL / RESIDENTIAL",
    "library.category.industrial": "INDUSTRIAL / STORAGE",
    "library.category.fortress": "FORTRESS / DEFENSE",
  ...
  "zh-Hans": Object.freeze({
    ...
    "library.title": "建筑库",
    "library.intro": "选择建筑后，空间预览、NCM 载荷、材料统计和 BOM 会同步替换。每个建筑库条目拥有确定性几何和默认配置，同时继续共用材料风格系统。",
    "library.future": "滚动建筑库 · 门由玩家单独放置",
    "library.aria": "可用的 NCM 建筑",
    "library.count": "{count} 个建筑",
    "library.selectAria": "选择 {building}",
    "library.category.residential": "住宅 / 参考建筑",
    "library.category.civic": "市政 / 治理建筑",
    "library.category.coastal": "海岸 / 住宅",
    "library.category.industrial": "工业 / 仓储",
    "library.category.fortress": "堡垒 / 防御",
