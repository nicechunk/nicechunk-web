...
try {
  ...
  assert.equal(agricultureBrowse.cardCount, 9);
  ...
  assert.match(constructionBrowse.previewTitle, /Compact Village Cheese House|Compact Village Poultry House|Compact Village Piggery/);
