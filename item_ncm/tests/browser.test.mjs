...
try {
  ...
  assert.match(initial.total, /59 ITEMS/);
  ...
  await waitFor(() => evaluate(client, `document.querySelectorAll("[data-item]").length === 12 && document.querySelector('[data-item="timber-workbench"]')`));
